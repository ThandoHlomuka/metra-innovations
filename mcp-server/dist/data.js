...
export const COMPANY = {
    ...
    description: 'Metra Innovations is a premier software development company based in Johannesburg, South Africa. ' +
...
export const SERVICES = [
    {
        ...
        description: 'Custom websites and web applications, WordPress development and customization, ' +
            'Progressive Web Apps (PWA), and API development and integration.'
    },
    {
        id: 'ecommerce',
        label: 'E-commerce Development',
        description: 'Custom ecommerce platforms, WooCommerce and Shopify, PayFast/Yoco/Ozow payment ' +
            'integration, and courier integrations (Pudo, PAXI).'
    },
    {
        id: 'mobile',
        label: 'Mobile App Development',
        description: 'iOS and Android apps built with React Native and Flutter, with data-efficient design.'
    },
    {
        id: 'software',
        label: 'Custom Software',
        description: 'Enterprise software solutions, CRM and ERP systems, and legacy system modernization.'
    },
    {
        id: 'cloud',
        label: 'Cloud Solutions',
        description: 'AWS and Azure hosting, DevOps and CI/CD, and POPIA compliant hosting.'
    },
    {
        id: 'consulting',
        label: 'IT Consulting',
        description: 'Digital transformation, POPIA compliance, and technical audits.'
    },
    {
        id: 'custom-solutions',
        label: 'Custom Solutions',
        description: 'Tailored software and web solutions built to specific business requirements.'
    },
    {
        id: 'other',
        label: 'Other',
...
export const PORTFOLIO = [
    {
        ...
        title: 'Online Store',
        category: 'E-commerce',
        description: 'A full-featured e-commerce platform built for online retail. Includes inventory management, ' +
    ...
    },
    {
        ...
        category: 'Software',
        description: 'A professional audio production software designed for musicians, producers, and audio engineers. ' +
    ...
    },
    {
        ...
        description: 'An electronic toll collection and payment platform enabling seamless toll payments for motorists. ' +
    ...
    },
    {
        ...
        title: 'Task Finder',
        category: 'Software',
        description: 'A comprehensive task management and productivity platform to organize, track, and complete work ' +
